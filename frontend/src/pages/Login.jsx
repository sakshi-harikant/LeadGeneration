...
// Same particle system used on the homepage: faint connected nodes that
// react gently to the cursor. Purely decorative — safe to drop into any page.
    ...
    <div className="relative min-h-screen bg-[#0A0D16] flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#8B93A7] text-sm mt-2">Log in to your LeadGen account</p>
        </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end mb-6">
              <Link to="/forgot-password" className="text-sm text-[#6C8BFF] hover:text-white transition">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-[#8B93A7] text-sm mt-6">
            ...
            <Link to="/signup" className="text-[#6C8BFF] hover:text-white transition">
              Sign up
            </Link>
          </p>
        </div>
